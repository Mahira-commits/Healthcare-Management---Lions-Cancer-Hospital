...
import com.example.lion_nav_barhomepage.flag
...
class pdfactivity : Fragment() {

    private var _binding: FragmentPdfactivityBinding? = null
    ...
    ): View? {_binding = FragmentPdfactivityBinding.inflate(inflater, container, false)
