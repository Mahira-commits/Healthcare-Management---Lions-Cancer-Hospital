...
import com.example.lion_nav_barhomepage.databinding.FragmentAddVaccineBinding
...
class AddVaccineFragment : Fragment() {
    ...
    ): View? {_binding = FragmentAddVaccineBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title="Vaccine"
        ...
        binding.upload.setOnClickListener {
            val vacname = binding.vname.text.toString()
            if(pdfuri!=null){
                upload(pdfuri,vacname)
                pdfuri=null
            }
    ...
    private fun upload(pdfuri: Uri?, vacname: String) {
